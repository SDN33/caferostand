...
const Story: React.FC = () => {
  ...
  <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <ScrollAnimation animation="fadeInUp" delay={200}>
          ...
          <div className="prose prose-white mx-auto text-center text-white leading-relaxed">
            <p>
          ...
          <p className="mt-6 text-sm text-gold">Passez nous voir, la porte est toujours ouverte pour un moment partagé.</p>
        </ScrollAnimation>
      </div>
    </section>
  );
